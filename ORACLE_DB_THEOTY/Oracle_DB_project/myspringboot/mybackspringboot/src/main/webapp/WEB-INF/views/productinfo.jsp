...
<script>
	$(function(){
		...
		$('div.productinfo>div.modal>button.productlist').click(function(){
			...
			//$('div.body >nav > a[type="productlist"]').trigger('click');
			var nav = document.querySelector('a[type="productlist"]');
	        	nav.click();
		});
		...
		$('div.productinfo>div.modal>button.viewcart').click(function(){
			...
			//$('div.body > nav > a[type="viewcart"]').trigger('click');
			var nav = document.querySelector('a[type="viewcart"]');
        	nav.click();
		});
